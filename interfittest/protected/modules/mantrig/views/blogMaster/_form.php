...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'blog_title',array('size'=>45,'maxlength'=>45)); ?>
...
<div class="row">
	...
	<?php echo $form->checkBox($model,'is_featured', array('value'=>1, 'uncheckValue'=>0)); ?>
		<?php echo $form->error($model,'is_featured'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'Author UID'); ?>
